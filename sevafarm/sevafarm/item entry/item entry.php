  ...
  <label>
    ...
    <h3>Add Here<h3>
        ...
        <select id="category" name="category">
    		...
    		<input type="" name="quantity" placeholder="<?php __('quantity')?>">
        <input type="" name="farmerid" placeholder="<?php __('farmer id')?>">
    		<input type="submit" name="">

    </form>
  </div>
  <div class="storage">
       <a href="sitem entry.php"><button type="button" class="login"><?php __('OPEN')?></button>
