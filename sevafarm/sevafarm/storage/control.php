    ...
    <div class="content-area">
      ...
      <form method="post">
          <table>
             ...
             <tr>
              <td><input type="" name="temp1" placeholder="temp ref"></td>
              <td><input type="" name="humidity1" placeholder="humidity ref"></td>
            </tr>
          </table>
          <div class="track" ><input class="track" value="Submit"  type="submit"></div>
      </form>
